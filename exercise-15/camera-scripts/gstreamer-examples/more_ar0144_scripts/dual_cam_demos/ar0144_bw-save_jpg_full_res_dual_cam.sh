...
echo " write side by side to 2560x800 Pixel, convert to jpg and write to ar0144_bw_dual_image.jpg"
echo " ============================================================================================"
echo ""
...
gst-launch-1.0 \
	v4l2src num-buffers=5 device=$VID_DEVICE_1 ! video/x-$BW_FORMAT,$FRAME_SIZE,framerate=30/1 ! \
	videoconvert ! jpegenc ! multifilesink location=ar0144_bw_image_cam1.jpg &
gst-launch-1.0 \
	v4l2src num-buffers=5 device=$VID_DEVICE_2 ! video/x-$BW_FORMAT,$FRAME_SIZE,framerate=30/1 ! \
	videoconvert ! jpegenc ! multifilesink location=ar0144_bw_image_cam2.jpg
...
#	video/x-$BW_FORMAT,$FRAME_SIZE,framerate=30/1 ! videoconvert ! mix. \
#	v4l2src num-buffers=5 device=$VID_DEVICE_2 ! \
#	video/x-$BW_FORMAT,$FRAME_SIZE,framerate=30/1 ! queue ! videoconvert ! mix. 
