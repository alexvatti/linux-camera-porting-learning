...
echo " read $SENSOR_RES (offset x,y=$OFFSET_SENSOR) and write to file ar0144_mono.raw"
echo " ===================================================================================="
echo ""
...
v4l2-ctl -d $VID_DEVICE -c dynamic_defect_pixel_correction=1
...
gst-launch-1.0 \
	...
	multifilesink location=ar0144_mono.raw

echo "File \"ar0144_mono.raw\" ($CAM_BW_FORMAT,$FRAME_SIZE)"	
