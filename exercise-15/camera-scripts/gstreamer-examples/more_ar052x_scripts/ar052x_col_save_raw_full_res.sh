...
echo "read $SENSOR_RES (offset x,y=$OFFSET_SENSOR) and write to file ar052x_bayer.raw"
echo "===================================================================================="
echo ""
...
gst-launch-1.0 \
	...
	multifilesink location=ar052x_bayer.raw

echo "File \"ar052x_bayer.raw\" ($COL_FORMAT$FRAME_SIZE)"	